...
convert +append `seq 1 16 | awk '{printf "mm46_towel_l_neutral_unit.png "}'` mm46_towel_l_neutral_line.png
convert -append `seq 1 16 | awk '{printf "mm46_towel_l_neutral_line.png "}'` mm46_towel_l_neutral_rect.png
convert -density 1200 -rotate +30 mm46_towel_l_neutral_rect.png mm46_towel_l_neutral_rot.png
convert -density 1200 -crop 4371x4725+9750+9573 mm46_towel_l_neutral_rot.png images-dist/mm46_towel_l_neutral.png
...
convert +append `seq 1 16 | awk '{printf "mm46_towel_l_chromatic_unit.png "}'` mm46_towel_l_chromatic_line.png
convert -append `seq 1 16 | awk '{printf "mm46_towel_l_chromatic_line.png "}'` mm46_towel_l_chromatic_rect.png
convert -density 1200 -rotate +30 mm46_towel_l_chromatic_rect.png mm46_towel_l_chromatic_rot.png
convert -density 1200 -crop 4371x4725+9750+9573 mm46_towel_l_chromatic_rot.png images-dist/mm46_towel_l_chromatic.png
